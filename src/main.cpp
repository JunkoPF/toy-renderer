...
int main() {
    ...
    auto white_metal = make_shared<Material>(Material::kMICROFACET, Vector3d(0.725, 0.71, 0.68), Vector3d(0, 0, 0), Vector3d(0, 0, 0), 20.0, 0.08, 0.95);
    ...
    Renderer renderer(400, aspect_ratio, 32, 0);
